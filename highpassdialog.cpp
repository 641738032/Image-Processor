...
#include "ui_highpassdialog.h"

HighPassDialog::HighPassDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::HighPassDialog)
{
    ui->setupUi(this);
}

HighPassDialog::~HighPassDialog()
{
    delete ui;
}

void HighPassDialog::on_buttonBox_accepted()
{
